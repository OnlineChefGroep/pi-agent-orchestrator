...
try {
  ({ getThemeColors, getBoxChars, framedRow, plainTheme, activeTheme } = await import(
    path.join(root, "dist/ui/theme.js")
  ));
  ...
  return [
    {
      id: "a1",
      type: "Explore",
      description: "Trace RPC + swarm health handlers",
      status: "running",
      swarmId: "swarm-alpha",
      joinMode: "swarm",
      toolUses: 14,
    ...
    },
    {
      id: "a2",
      type: "Explore",
      description: "Scan test/ coverage gaps",
      status: "running",
      swarmId: "swarm-alpha",
      joinMode: "swarm",
      toolUses: 9,
    ...
    },
    {
      id: "a3",
      type: "Plan",
      description: "v0.11.0 release checklist",
      status: "running",
      toolUses: 6,
      startedAt: t - 22_000,
      spawnedAt: t - 22_000,
    },
    {
      ...
      description: "Virtual scroll + heatmap polish",
      status: "queued",
      toolUses: 0,
      startedAt: t,
      spawnedAt: t,
    },
    {
      id: "a5",
      type: "Analysis",
      description: "Benchmark fastTruncate",
      status: "completed",
      toolUses: 22,
      startedAt: t - 100_000,
      completedAt: t - 12_000,
      spawnedAt: t - 100_000,
    },
    {
      id: "a6",
      type: "Plan",
      description: "Schedule bounds audit",
      status: "error",
      error: "rate limited",
      toolUses: 2,
      startedAt: t - 70_000,
      completedAt: t - 65_000,
      spawnedAt: t - 70_000,
    },
  ].map((a, i) => ({
    compactionCount: 0,
