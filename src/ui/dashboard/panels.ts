...
export function renderDashboardFooter(
  ...
  const secondary = "y tree  ·  z sch  ·  p perms  ·  w swarm  ·  r refresh  ·  /:cmd  ·  ? help  ·  q/esc close";
...
export function renderDashboardHelp(
  ...
  const helpLines = [
    ...
    "",
    section("Top View Sort Keys"),
    key("t / r / d / u / l / n", "Sort by tokens / turns / duration / tools / lastSeen / name"),
    key("← / →", "Page through agents"),
    "",
    section("Actions"),
    ...
    key("t", "Toggle top/resource view"),
    key("y", "Toggle execution tree view"),
