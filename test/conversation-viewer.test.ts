...
vi.mock("../src/ui/tui-shim.js", async (importOriginal) => {
  const original = await importOriginal<typeof import("../src/ui/tui-shim.js")>();
  return {
    ...original,
...
describe("ConversationViewer", () => {
  ...
  describe("safety net against upstream wrapTextWithAnsi bugs", () => {
    ...
    it("mock is intercepting wrapTextWithAnsi", async () => {
      const { wrapTextWithAnsi } = await import("../src/ui/tui-shim.js");
