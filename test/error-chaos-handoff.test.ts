...
\`\`\``;
    ...
    expect(result).toBeNull();
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining("Missing or invalid fields"));
  });
...
\`\`\``;
    ...
    expect(result).toBeNull();
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining("JSON key count exceeds maximum"));
  });
...
\`\`\``;
    ...
    expect(result).toBeNull();
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining("summary (too long)"));
  });
...
\`\`\``;
    ...
    expect(result).toBeNull();
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining("findings (too many"));
  });
